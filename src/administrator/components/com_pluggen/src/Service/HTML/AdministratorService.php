...
use Yepr\Component\Pluggen\Administrator\Service\HTML\ArrayHelper;
...
class AdministratorService
{
	...
	public function association($projectid)
	{
		...
		if ($associations = Associations::getAssociations('com_pluggen', '#__pluggen_projects', 'com_pluggen.item', $projectid, 'id', null))
		{
			...
			if ($items)
			{
				foreach ($items as &$item)
				{
					...
					$url = Route::_('index.php?option=com_pluggen&task=project.edit&id=' . (int) $item->id);
