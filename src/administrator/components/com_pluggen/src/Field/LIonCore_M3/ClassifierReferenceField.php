...
class ClassifierReferenceField extends ListField
{
	//The field class must know its own type through the variable $type.
	protected $type = 'ClassifierReference';

	/**
	 * Get the options for the list field: all Classifiers (= Concepts + ConceptInterfaces + Annotations)  currently in the project
	 *
	 */
	public function getOptions()
	{
		...
		// Todo: sort
		// Todo: also get the classifiers of the dependent languages, if applicable
