...
class AnnotationReferenceField extends ListField
{
	//The field class must know its own type through the variable $type.
	protected $type = 'AnnotationReference';

	/**
	 * Get the options for the list field: all Classifiers (= Concepts + Annotations)  currently in the project
	 *
	 */
	public function getOptions()
	{
		...
		// Todo: sort
		// Todo: also get the annotations of the dependent languages, if applicable
