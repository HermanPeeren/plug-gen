...
namespace administrator\components\com_pluggen\src\Field\Modal;
...
class ProjectField extends FormField
{
	...
	protected function getInput()
	{
		...
		$linkProjects = 'index.php?option=com_pluggen&amp;view=projects&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1';
		$linkProject  = 'index.php?option=com_pluggen&amp;view=project&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1';
		$modalTitle   = Text::_('COM_PLUGGEN_SELECT_A_PROJECT');
		...
		$title = empty($title) ? Text::_('COM_PLUGGEN_SELECT_A_PROJECT') : htmlspecialchars($title, ENT_QUOTES, 'UTF-8');
		...
		if ($allowSelect)
		{
			$html .= '<button'
				...
				. ' title="' . HTMLHelper::tooltipText('COM_PLUGGEN_SELECT_A_PROJECT') . '">'
		...
		$html .= '<input type="hidden" id="' . $this->id . '_id"' . $class . ' data-required="' . (int) $this->required . '" name="' . $this->name
			. '" data-text="' . htmlspecialchars(Text::_('COM_PLUGGEN_SELECT_A_PROJECT', true), ENT_COMPAT, 'UTF-8') . '" value="' . $value . '">';
