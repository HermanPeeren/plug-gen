...
/**
 ...
 <li>@subpackage  Pluggen component
 <li>@version     0.8.0
 *
...
namespace administrator\components\com_pluggen\src\View\Info;
...
custom fields, ordering, access control, language associations, routing/alias, action logs, finder</li>
    ...
    <li>update-site for pluggen; update from github</li>
</ul>
...
<li>update pluggen info page(s) from github instead of shipping with component</li>
...
INFO;
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_PLUGGEN_MANAGER_INFO'), 'generators');

		HTMLHelper::_('sidebar.setAction', 'index.php?option=com_pluggen');
	}
}
