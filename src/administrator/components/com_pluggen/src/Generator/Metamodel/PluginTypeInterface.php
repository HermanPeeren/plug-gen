...
{
    /**
     * The tag stamped around a slot in generated files.
     *
     * It lives beside `slots()` because it is the other half of the same idea:
     * a slot is an insertion point, and this is what marks one in the output so
     * that regenerating can find the code somebody put there.
     *
     * Named rather than repeated. The library's merger takes the tag as a
     * constructor argument - a file generated by one tool should not carry
     * another tool's marker - so before this there were three string literals
     * and a golden file that would only notice two of them disagreeing.
     *
     * @since  0.5.0
     */
    public const REGION_TAG = 'pluggen';
