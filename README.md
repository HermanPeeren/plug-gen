...
Will do a first release as soon as this is usable. And then each add other plugin types. Seer the series about creating custom plugins in the [Joomla Community Magazine](https://magazine.joomla.org/). 

Herman Peeren, 19-5-2026
